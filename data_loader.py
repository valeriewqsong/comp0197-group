...
def split_data(annotations_file,  labeled_samples=100):
    ...
    unlabeled_data = img_labels[labeled_samples:labeled_samples ]
...
def get_data_loader(batch_size=32, num_workers=0, labeled_samples=100):
    ...
    labeled_data, unlabeled_data = split_data('annotations/trainval.txt',  labeled_samples)
    test_labeled_data, test_unlabeled_data = split_data('annotations/test.txt',  labeled_samples)
